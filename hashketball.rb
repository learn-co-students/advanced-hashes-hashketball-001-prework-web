...
def num_points_scored(player)
  game_hash_fetched = game_hash

  game_hash_fetched.each do |team_key, team_attributes|
    team_attributes[:players].each do |player_key, player_attributes|
      return player_attributes[:points] if player_key == player
    end
  end
end
...
def shoe_size(player)
  ...
  game_hash_fetched.each do |team_key, team_attributes|
    team_attributes[:players].each do |player_key, player_attributes|
      return player_attributes[:shoe] if player_key == player
    end
  end
end
...
def player_numbers(team)
  ...
  game_hash_fetched.each do |team_key, team_attributes|
    team_attributes[:players].each do |player_key, player_attributes|
      team_numbers << player_attributes[:number] if team_attributes[:team_name] == team
    end
  end
...
def player_stats(player)
  ...
  game_hash_fetched.each do |team_key, team_attributes|
    team_attributes[:players].each do |player_key, player_attributes|
      return player_attributes if player_key == player
    end
  end
end
...
def big_shoe_rebounds
  ...
  game_hash_fetched.each do |team_key, team_attributes|
    team_attributes[:players].each do |player_key, player_attributes|
      ...
      shoe_sizes << player_attributes[:shoe]
    end
  end
